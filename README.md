>>> 前處理後樣本: 
 ...
 drugrec：藥物推薦 (Drug Recommendation)

mortality：死亡率預測 (Mortality Prediction)

readmission：再住院風險預測 (Readmission Prediction)

lenofstay：住院天數預測 (Length-of-Stay Prediction)
